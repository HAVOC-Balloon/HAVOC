...
void SPILogger::writeTelemetry(Data &data) {
    ...
    telemetryFile.print(",");
    telemetryFile.print(data.gyro.x, 4);
    telemetryFile.print(",");
    telemetryFile.print(data.gyro.y, 4);
    telemetryFile.print(",");
    telemetryFile.print(data.gyro.z, 4);
    telemetryFile.print(",");
    telemetryFile.print(data.orientation.x, 4);
    telemetryFile.print(",");
    telemetryFile.print(data.orientation.y, 4);
    telemetryFile.print(",");
    telemetryFile.print(data.orientation.z, 4);
    telemetryFile.print(",");
